...
class BaseOptions:
    ...
    def initialize(self, parser):
        ...
        # basic parameters
        parser.add_argument('--dataroot', default='./datasets/summer2autumn', help='')
        parser.add_argument('--name', type=str, default='summer2autumn_DCL',
                            help='name of the experiment. It decides where to store samples and models')
        parser.add_argument('--use_wandb', action='store_true', help='use wandb')
        parser.add_argument('--easy_label', type=str, default='summer2autumn', help='Interpretable name')
