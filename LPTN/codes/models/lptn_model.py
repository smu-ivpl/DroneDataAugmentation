        ...
        for idx, val_data in enumerate(dataloader):
            ...
            if with_metrics:
                ...
                for name, opt_ in opt_metric.items():
                    ...
                    # self.metric_results[name] += getattr(metric_module, metric_type)(result_img, gt_img, **opt_)
                    self.metric_results[name] += getattr(metric_module, metric_type)(result_img, input_img, **opt_)
            pbar.update(1)
